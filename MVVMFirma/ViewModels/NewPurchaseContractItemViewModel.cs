...
{
    public class NewPurchaseContractItemViewModel : OneViewModel<Items>, IDataErrorInfo
    {
        public NewPurchaseContractItemViewModel() : base()
        {
            base.DisplayName = "New Purchase Contract Item";
            item = new Items();

            item.item_status_id = 1;
            item.acquisition_source_type_id = 1;
        ...
        {
            get { return pawnShopEntities.Categories.Where(x => x.is_active == true).ToList().AsQueryable(); }
        }
        ...
        {
            return this["Estimated_Value"] == null && this["Sale_Price"] == null;
        }
        #endregion
    }
}